...
"Виды ООП"
# 1. Наследование - позволяет нам наследовать методы и атрибуты с родительского класса к дочерней(— это процесс, когда один класс наследует атрибуты и методы другого.)
# 2. Инкапсуляция - сокрытие данных, сбор данных в одну капсулу (класс) (– механизм сокрытия деталей реализации класса от других объектов.)
# 3. Полиморфизм  - (– разное поведение одного и того же метода в разных классах. )

# 4. Абстракция – это конструкторы, позволяющие создавать последовательности из других последовательностей.
# 5. Ассоциация –